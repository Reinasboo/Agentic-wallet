...
```typescript
type AgentStatus = 'idle' | 'thinking' | 'executing' | 'waiting' | 'error' | 'stopped';
...
type TransactionType = 'airdrop' | 'transfer_sol' | 'transfer_spl' | 'create_token_account';
